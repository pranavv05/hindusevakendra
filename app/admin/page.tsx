      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Complete registration statistics and user management
          </p>
        </div>
        ...
        <Tabs defaultValue="all-users" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="all-users">
              All Registrations ({stats.total_registrations})
            </TabsTrigger>
            <TabsTrigger value="users-only">
              Service Users ({stats.total_users})
            </TabsTrigger>
            <TabsTrigger value="vendors-only">
          ...
          <TabsContent value="all-users">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Complete list of all users and vendors registered on the
                  platform
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="users-only">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Users who request services on the platform
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="overflow-x-auto">
